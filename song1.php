    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg fixed-top" id="mainNav">
            <div class="container px-4">
                <a class="navbar-brand" style="color: #E5E4E4" href="index.php"> EUPHORIA </a>
        ...
        <section class="bg-image"
            style = "background-image: url(images/photo_2.jpg);height: 100vh width: 100vw" id="songs">
            <div class="container px-4 ">
        ...
        <footer class="py-3 bg-info">
            <div class="container px-4"><p class="m-0 text-center text-dark">Copyright &copy; 2022. Darea Anne M. Jawili</p></div>
        </footer>
        <!-- Bootstrap core JS-->
